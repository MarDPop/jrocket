 ...
 * @author mpopescu
 */
public class IntegratorRKF extends Integrator {
    private double[] k1;
    private double[] k2;
    private double[] k3;
    private double[] k4;
    ...
    public IntegratorRKF(double startTime, double endTime, double[] initialState) {
        this(startTime, endTime, initialState, new double[initialState.length][initialState.length],new double[]{1,1e-3,1e-4,1e-2,0});
        dt = 1; //initial step
    }
    
    public IntegratorRKF(double startTime, double endTime, double[] initialState, double[][] covariance, double[] options ) {
