 ...
 * @author mpopescu
 */
public class IntegratorRK78 extends Integrator {
    private double[] k1;
    private double[] k2;
    private double[] k3;
    private double[] k4;
    ...
    public IntegratorRK78(double startTime, double endTime, double[] initialState) {
        this(startTime, endTime, initialState, new double[initialState.length][initialState.length],new double[]{1,1e-3,1e-4,1e-2,0});
        dt = 1; //initial step
    }
    
    public IntegratorRK78(double startTime, double endTime, double[] initialState, double[][] covariance, double[] options ) {
        ...
        k8 = new double[nStates];
        k9 = new double[nStates];
        k10 = new double[nStates];
        k11 = new double[nStates];
        k12 = new double[nStates];
        k13 = new double[nStates];
